...
> by providing the feature names (from the feature view / feature group)
e.g query = fg1.select(["id", "feature1"]).join(fg2.select(["id", "feature2"]), prefix="fg2_")
meaning that the feature name can be "feature2" or "fg2_feature2"?
